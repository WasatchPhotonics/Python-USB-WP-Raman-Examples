"""
fw_util - Minimal GUI for flashing STM and BLE
"""
...
def button_flash_clicked(selection, erase):
    """Send appropriate commands to the JLinkEXE"""

    # Build list of commands based on input
    if selection == 'BL652':
    ...
    if selection == 'STM32':
        # Dictionary of commands and expected responses to check for
    ...
    # Write to temp file and call .exe
...
def main():
    ...
    button_flash = tk.Button(root, text="Flash", command= lambda: button_flash_clicked(sel.get(), erase.get()))
