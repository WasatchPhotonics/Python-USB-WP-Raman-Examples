...
Z = [0] * BUFFER_SIZE
TIMEOUT_MS = 1000
VR_GET_LASER_POWER_ATTENUATION = 0x8f
...
idleTmoSecs = get_img_snsr_idle_tmo_val()
print("Image Sensor Idle-Tmo is {} secs".format(idleTmoSecs))
