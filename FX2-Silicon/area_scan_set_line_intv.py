...
class Fixture():
    def __init__(self):
        if len(sys.argv) < 2:
            print(f"Usage: python {sys.argv[0]} <line_intv in decimal>")
            sys.exit(1)

        progname = sys.argv.pop(0)
        self.line_intv = int(sys.argv.pop(0), 10)
...
fixture = Fixture()
if fixture.dev:
    if fixture.line_intv < 1 or fixture.line_intv > 255:
       print("line cnt range is 1 to 255 !!")
    else:
       print("line_intv is ", fixture.line_intv)
       fixture.send_cmd(0xa8, fixture.line_intv)
    # fixture.run()
